...
export function LoginPage() {
  ...
  const [password, setPassword] = useState('@AnaliseSped2026')
      ...
      <main className="flex flex-col justify-center bg-white px-5 py-8 sm:px-10 lg:px-16">
        <div className="mx-auto w-full max-w-sm space-y-6">
          <div className="flex flex-col items-center gap-2 lg:hidden">
            ...
            <p className="text-[10px] tracking-[0.15em] uppercase text-muted-foreground/40">Confronto SPED × XML</p>
          </div>

          <header className="text-center">
            <h1 className="text-xl font-semibold tracking-tight text-foreground">Entrar</h1>
            <p className="mt-1 text-[13px] text-muted-foreground">Acesse o sistema de confronto fiscal</p>
          </header>
          ...
          <div className="rounded-md border border-amber-200/80 bg-amber-50/60 px-3 py-2">
            <div className="flex items-start gap-2">
              ...
              <div className="text-[11px] leading-relaxed text-amber-700">
                ...
                <p className="mt-0.5">
                  Usuário: <code className="rounded bg-amber-100/80 px-1 py-px font-mono text-amber-800">admin</code>
                  {' · '}
                  Senha: <code className="rounded bg-amber-100/80 px-1 py-px font-mono text-amber-800">@AnaliseSped2026</code>
                </p>
              </div>
            </div>
          </div>
