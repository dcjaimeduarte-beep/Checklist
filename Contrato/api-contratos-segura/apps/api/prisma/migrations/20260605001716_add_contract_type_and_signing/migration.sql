-- CreateTable
CREATE TABLE "contract_type_configs" (
    "id" TEXT NOT NULL PRIMARY KEY,
    "type" TEXT NOT NULL,
    "display_name" TEXT NOT NULL,
    "clause_overrides" TEXT,
...
CREATE TABLE "new_contracts" (
    ...
    "contract_type" TEXT NOT NULL DEFAULT 'SOLUTIO_ERP',
    "sign_token" TEXT,
    "sign_token_expires_at" DATETIME,
    "signed_by_name" TEXT,
    "signed_by_ip" TEXT,
    "signed_by_name_contratante" TEXT,
    "signed_at_contratante" DATETIME,
    "signed_by_ip_contratante" TEXT,
    "created_at" DATETIME NOT NULL DEFAULT CURRENT_TIMESTAMP,
    "updated_at" DATETIME NOT NULL,
    CONSTRAINT "contracts_client_id_fkey" FOREIGN KEY ("client_id") REFERENCES "clients" ("id") ON DELETE RESTRICT ON UPDATE CASCADE
);
INSERT INTO "new_contracts" ("adjustment_index", "adjustment_rate", "client_id", "created_at", "discount", "distance_from_provider_km", "duration_months", "end_date", "first_payment_date", "id", "identifier", "implementation_fee", "implementation_payment", "is_signed", "last_adjustment_date", "module_cadastros", "module_faturamento", "module_fiscal", "monthly_fee", "notes", "payment_day_of_month", "signed_at", "start_date", "status", "updated_at") SELECT "adjustment_index", "adjustment_rate", "client_id", "created_at", "discount", "distance_from_provider_km", "duration_months", "end_date", "first_payment_date", "id", "identifier", "implementation_fee", "implementation_payment", "is_signed", "last_adjustment_date", "module_cadastros", "module_faturamento", "module_fiscal", "monthly_fee", "notes", "payment_day_of_month", "signed_at", "start_date", "status", "updated_at" FROM "contracts";
...
-- CreateIndex
CREATE UNIQUE INDEX "contract_type_configs_type_key" ON "contract_type_configs"("type");
